...
def chiba_road(address):
    ...
    driver.save_screenshot(".\\img\\chiba_road.png")
    #pdf変換
    image = Image.open(".\\img\\chiba_road.png")
    im_pdf = image.convert("RGB")
    im_pdf.save(".\\img\\chiba_road.pdf")